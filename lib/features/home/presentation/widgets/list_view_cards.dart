  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        CardComponent(cardColor: ManageColors.card2.withOpacity(0.65), cardImagePath: 'assets/images/praying.png', cardTitle: 'القراء', onTap: (){}),
        CardComponent(cardColor: ManageColors.card1.withOpacity(0.65), cardImagePath: 'assets/images/listening.png', cardTitle: 'الأدعية والأذكار', onTap: (){}),
