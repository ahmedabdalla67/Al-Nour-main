  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        CardComponent(cardColor: ManageColors.card1.withOpacity(0.65), cardImagePath: 'assets/images/islamic_library.png', cardTitle: 'كتب اسلامية', onTap: (){customNavigate(context, '/hadith');}),
